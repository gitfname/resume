...
function AppBanner() {
	...
	return (
		...
		>
			<div className="w-full md:w-1/3 text-left self-start mt-20">
				<motion.h1
					initial={{ opacity: 0 }}
					animate={{ opacity: 1 }}
					transition={{
				...
				<motion.p
					...
					className="font-general-medium mt-2.5 text-lg md:text-xl text-center sm:text-left leading-normal text-transparent/30 dark:text-white/30"
				>
